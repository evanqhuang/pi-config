...
test("full parent reminder preserves clarification and submit-only approval contract", () => {
  ...
  for (const required of [
    ...
    "synthesize inspected evidence into an implementation-ready plan",
    "trace proposed changes to facts or labeled assumptions",
    "using the plan structure that best fits the work instead of padding a fixed template",
